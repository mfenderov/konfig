...
func TestLoadInto_EmptyKonfigTag(t *testing.T) {
	...
	// Fields without konfig tag should use default value
	if cfg.WithoutTag != "without_konfig_tag" {
		t.Errorf("Expected WithoutTag 'without_konfig_tag', got '%s'", cfg.WithoutTag)
	}
